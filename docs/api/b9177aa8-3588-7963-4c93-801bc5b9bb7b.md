# Exists(*TParameters*, *TQueryResult*) Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;WeelinkIT.FluentSQL.Querying.Statements.Exists(TParameters, TQueryResult)<br />
...
The Exists(TParameters, TQueryResult) type exposes the following members.
...
<a href="#exists(*tparameters*,-*tqueryresult*)-class">Back to Top</a>
...
Convert this Exists(TParameters, TQueryResult) to a `bool`, so that it can be used in a <a href="36a7454c-4550-b129-5cbf-e5e695cc1bb7">Where(TParameters, TQueryResult)</a>.</td></tr></table>&nbsp;
<a href="#exists(*tparameters*,-*tqueryresult*)-class">Back to Top</a>
