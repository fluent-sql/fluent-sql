# Where(*TParameters*, *TQueryResult*) Class
 

The `WHERE`-statement of a <a href="82639357-28f5-d7fe-833e-926791d1bac8">Query(TParameters, TQueryResult)</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;WeelinkIT.FluentSQL.Querying.Statements.Where(TParameters, TQueryResult)<br />
...
The Where(TParameters, TQueryResult) type exposes the following members.
...
<a href="#where(*tparameters*,-*tqueryresult*)-class">Back to Top</a>
