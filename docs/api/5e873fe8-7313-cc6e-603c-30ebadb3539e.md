# OuterJoin(*TParameters*, *TQueryResult*, *TTable*) Class
 

The `OUTER JOIN`-statement of a <a href="82639357-28f5-d7fe-833e-926791d1bac8">Query(TParameters, TQueryResult)</a>.


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="30b99062-7181-baa6-6302-db25f3edf1fb">WeelinkIT.FluentSQL.Querying.Statements.Join</a>(*TParameters*, *TQueryResult*, *TTable*)<br />&nbsp;&nbsp;&nbsp;&nbsp;WeelinkIT.FluentSQL.Querying.Statements.OuterJoin(TParameters, TQueryResult, TTable)<br />
...
The OuterJoin(TParameters, TQueryResult, TTable) type exposes the following members.
...
<a href="#outerjoin(*tparameters*,-*tqueryresult*,-*ttable*)-class">Back to Top</a>
