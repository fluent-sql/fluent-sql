...
#### Type Parameters
&nbsp;<dl><dt>TType</dt><dd>\[Missing <typeparam name="TType"/> documentation for "T:WeelinkIT.FluentSQL.Querying.Functions.Count`1"\]</dd></dl>&nbsp;
The Count(TType) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="c424258e-c092-77ad-902c-37c6c1781e8e">Count(TType)</a></td><td>
Create a new COUNT-expression.</td></tr></table>&nbsp;
<a href="#count(*ttype*)-class">Back to Top</a>
