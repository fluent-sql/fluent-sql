# SqlExpression(*TExpressionType*).LessThanOrEqual Operator (SqlExpression(*TExpressionType*), *TExpressionType*)
 

Allows for an `less than or equal` comparison between a <a href="6d3bd1b1-9588-4b2a-b617-fde5eea88b0a">SqlExpression(TExpressionType)</a> and a value of type *TExpressionType*.
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a><br />\[Missing <returns> documentation for "M:WeelinkIT.FluentSQL.Modelling.SqlExpression`1.op_LessThanOrEqual(WeelinkIT.FluentSQL.Modelling.SqlExpression{`0},`0)"\]
