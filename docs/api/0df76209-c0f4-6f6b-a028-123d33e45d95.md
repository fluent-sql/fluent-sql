# GroupByExtensions.GroupBy(*TParameters*, *TQueryResult*, *TSqlExpression*) Method 
 

Add a new `GROUP BY` to the <a href="82639357-28f5-d7fe-833e-926791d1bac8">Query(TParameters, TQueryResult)</a>.
...
#### Return Value
Type: <a href="0a423b57-2c21-1e1e-c4d9-e6fec2bc8428">GroupBy</a>(*TParameters*, *TQueryResult*, *TSqlExpression*)<br />The <a href="0a423b57-2c21-1e1e-c4d9-e6fec2bc8428">GroupBy(TParameters, TQueryResult, TSqlExpression)</a>.
