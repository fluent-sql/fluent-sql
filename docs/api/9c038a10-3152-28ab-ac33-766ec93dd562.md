# JoinExtensions.OuterJoin(*TParameters*, *TQueryResult*, *TTable*) Method (QueryComponent(*TParameters*, *TQueryResult*), Expression(Func(*TTable*)))
 

Add a new `OUTER JOIN` to the <a href="82639357-28f5-d7fe-833e-926791d1bac8">Query(TParameters, TQueryResult)</a>.
...
#### Return Value
Type: <a href="5e873fe8-7313-cc6e-603c-30ebadb3539e">OuterJoin</a>(*TParameters*, *TQueryResult*, *TTable*)<br />The <a href="5e873fe8-7313-cc6e-603c-30ebadb3539e">OuterJoin(TParameters, TQueryResult, TTable)</a>.
