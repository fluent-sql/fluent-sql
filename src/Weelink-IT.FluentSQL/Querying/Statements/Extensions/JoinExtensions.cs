...
namespace WeelinkIT.FluentSQL.Querying.Statements.Extensions
{
    ...
    public static class JoinExtensions
    {
        ...
        /// </param>
        /// <returns>The <see cref="WeelinkIT.FluentSQL.Querying.Statements.LeftJoin{TParameters, TQueryResult, TTable}" />.</returns>
        ...
        ///     The <see cref="Expression{TDelegate}">Expression&lt;Func&lt;TTable&gt;&gt;</see> that selects the child to join with.
        /// </param>
        /// <returns>The <see cref="WeelinkIT.FluentSQL.Querying.Statements.RightJoin{TParameters, TQueryResult, TTable}" />.</returns>
        ...
        ///     The <see cref="Expression{TDelegate}">Expression&lt;Func&lt;TTable&gt;&gt;</see> that selects the child to join with.
        /// </param>
        /// <returns>The <see cref="WeelinkIT.FluentSQL.Querying.Statements.InnerJoin{TParameters, TQueryResult, TTable}" />.</returns>
        ...
        ///     The <see cref="Expression{TDelegate}">Expression&lt;Func&lt;TTable&gt;&gt;</see> that selects the child to join with.
        /// </param>
        /// <returns>The <see cref="WeelinkIT.FluentSQL.Querying.Statements.OuterJoin{TParameters, TQueryResult, TTable}" />.</returns>
