...
{
    public sealed class Having<TModel, TResult, TTable> : QueryComponent<TModel, TResult>, ExtensionPoint<TModel, TResult, TTable>
        where TTable : Table
        where TModel : PersistenceModel
    {
        public Having(QueryContext<TModel, TResult> queryContext, Expression<Func<TTable, bool>> expression)
        {
