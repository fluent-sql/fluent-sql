...
{
    public sealed class RightJoin<TModel, TResult, TChild, TParent> : QueryComponent<TModel, TResult>
        ...
        where TChild : Table
    {
        ...
        public RightJoin<TModel, TResult, TChild, TParent> As(string alias)
        {
