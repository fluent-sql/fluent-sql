...
namespace WeelinkIT.FluentSQL.Querying.Extensions
{
    ...
    public static class GroupByExtensions
    {
        ...
        /// <returns>The <see cref="WeelinkIT.FluentSQL.Querying.GroupBy{TModel, TParameters, TResult, TTable, TType}" />.</returns>
        ...
        /// <summary>
        ///     The <c>GROUP BY</c>-statement of a <see cref="Query{TParameters, TResult}" /> based on a 
        ///     <see cref="Select{TModel, TParameters, TResult, TTable, TType}" />.
        /// </summary>
        /// <typeparam name="TModel">The <see cref="PersistenceModel" />.</typeparam>
        /// <typeparam name="TParameters">
        ///     The parameters required for executing this <see cref="Query{TParameters, TResult}" />.
        ...
        public static GroupBy<TModel, TParameters, TResult, TTable, TType> GroupBy<TModel, TParameters, TResult, TTable, TType>(
            this Select<TModel, TParameters, TResult, TTable, TType> subject)
            where TModel : PersistenceModel
            where TTable : Table
            where TParameters : new()
        {
            QueryContext<TModel, TParameters, TResult> queryContext = subject.GetQueryContext();
            var groupBy = new GroupBy<TModel, TParameters, TResult, TTable, TType>(queryContext, subject);
