...
namespace WeelinkIT.FluentSQL.Querying.Extensions
{
    ...
    public static class SumExtensions
    {
        ...
        public static SqlExpression<int> Sum(this SqlExpression<long> subject)
        {
        ...
        /// <returns>A <see cref="SqlExpression{Int64}" /> representing the summed total.</returns>
        public static SqlExpression<int> Sum(this SqlExpression<decimal> subject)
        {
        ...
        /// <returns>A <see cref="SqlExpression{Int64}" /> representing the summed total.</returns>
        public static SqlExpression<int> Sum(this SqlExpression<float> subject)
        {
