...
{
    public sealed class InnerJoin<TModel, TResult, TChild, TParent> : QueryComponent<TModel, TResult>
        ...
        where TChild : Table
    {
        ...
        public InnerJoin<TModel, TResult, TChild, TParent> As(string alias)
        {
